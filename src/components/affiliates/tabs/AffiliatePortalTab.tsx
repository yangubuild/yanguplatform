...
export function AffiliatePortalTab() {
  ...
  return (
    <div className="max-w-[700px]">
      <h3 className="text-lg font-semibold text-foreground mb-4">Affiliate setup</h3>
      ...
      <div className="rounded-xl border border-white/[0.04] divide-y divide-white/[0.04] mb-8" style={{ background: "#111a15" }}>
        ...
        <div className="flex items-center gap-4 p-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-foreground">Portal link</p>
            <p className="text-xs text-muted-foreground mt-0.5">Give your affiliates a place to organize their resources</p>
          </div>
          <button
        ...
        <div className="flex items-center gap-4 p-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">Set up a waitlist for your affiliates program</p>
          </div>
      ...
      <h3 className="text-lg font-semibold text-foreground mb-4">Affiliate management</h3>

      <div className="flex items-center gap-3 mb-4">
        <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-muted-foreground border border-white/[0.06]">
          Status: <span className="text-foreground font-medium">{statusFilter}</span>
        </button>
