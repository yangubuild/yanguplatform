...
export function RevenueShareTab() {
  ...
  return (
    <div className="max-w-[700px]">
      <h3 className="text-lg font-semibold text-foreground mb-4">Revenue share partners</h3>
      ...
      <div className="rounded-xl border border-white/[0.04] mb-6" style={{ background: "#111a15" }}>
        <button
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-foreground">Share your revenue</p>
            <p className="text-xs text-muted-foreground mt-0.5">Automatically pay partners a percentage of all sales</p>
          </div>
    ...
    <div className="fixed inset-0 z-[9999] flex justify-end">
      ...
      <div className="relative w-full max-w-sm h-full flex flex-col border-l border-white/[0.04]" style={{ background: "#111a15" }}>
        ...
        <div className="flex items-center justify-between p-5 border-b border-white/[0.04]">
          <h3 className="text-base font-semibold text-foreground">Share your revenue</h3>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          <div>
            ...
            />
            <p className="text-[11px] text-muted-foreground mt-1">You can add users by their email, yangu username, or user ID.</p>
          </div>

          <div>
            <label className="text-sm text-muted-foreground mb-1.5 block">Share type ⓘ</label>
          ...
          <div>
            <label className="text-sm text-muted-foreground mb-1.5 block">Share %</label>
            <div className="relative">
              <input
                value={sharePercent}
                onChange={(e) => setSharePercent(e.target.value)}
                className="w-full h-10 px-3 rounded-lg bg-white/5 border border-white/[0.06] text-sm text-foreground focus:outline-none focus:border-accent/40"
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-muted-foreground">%</span>
            </div>
            <p className="text-[11px] text-muted-foreground mt-1">Partner receives this percentage of all sales</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/[0.06] mb-2">
              ...
              <input className="bg-transparent text-sm text-foreground placeholder:text-muted-foreground focus:outline-none w-full" placeholder="Search products" />
            </div>
            <div className="rounded-lg border border-white/[0.06] p-3 flex items-center gap-3">
              <input type="checkbox" className="rounded border-white/20" />
              <div className="flex-1 min-w-0">
                <p className="text-sm text-foreground">Budget-Friendly Meal Prep Kits</p>
              </div>
