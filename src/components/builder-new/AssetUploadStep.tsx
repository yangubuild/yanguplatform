  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-[88%]">
      ...
      <button
        onClick={onConfirm}
        disabled={!canConfirm}
        className="self-start px-5 py-2 text-[12px] font-semibold rounded-lg bg-accent text-accent-foreground hover:opacity-90 transition-opacity disabled:bg-muted disabled:text-muted-foreground disabled:opacity-60"
      >
