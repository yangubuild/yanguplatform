...
const EN: CopyMap = {
  ...
  country: "Which country is your business in?",
  products_services: "What products or services do you offer? List a few — I'll structure them for you.",
  payment_methods: "How would you like to accept payments? Mobile money, cards, cash, bank transfer, or all of them?",
  sell_channel: "Where do you plan to sell most? A website, social media, WhatsApp, or a combination?",
...
const FR: CopyMap = {
  ...
  country: "Dans quel pays se trouve votre entreprise ?",
  products_services: "Quels produits ou services proposez-vous ? Citez-en quelques-uns.",
  payment_methods: "Comment souhaitez-vous accepter les paiements ? Mobile money, cartes, espèces, virement, ou tous ?",
  sell_channel: "Où prévoyez-vous de vendre le plus ? Site web, réseaux sociaux, WhatsApp ou une combinaison ?",
...
const AR: CopyMap = {
  ...
  country: "في أي بلد يقع عملك؟",
  products_services: "ما المنتجات أو الخدمات التي تقدمها؟ اذكر بعضها.",
  payment_methods: "كيف تريد قبول المدفوعات؟ محفظة موبايل، بطاقات، نقد، تحويل بنكي، أو الكل؟",
  sell_channel: "أين تخطط للبيع غالبًا؟ موقع، وسائل تواصل، واتساب، أو مزيج؟",
...
const SW: CopyMap = {
  ...
  country: "Biashara yako iko nchi gani?",
  products_services: "Unatoa bidhaa au huduma gani? Taja chache.",
  payment_methods: "Ungependa kupokea malipo vipi? Mobile money, kadi, fedha taslimu, benki, au yote?",
  sell_channel: "Unapanga kuuza zaidi wapi? Tovuti, mitandao ya kijamii, WhatsApp, au mchanganyiko?",
...
const LG: CopyMap = {
  ...
  country: "Bizinensi yo eri mu nsi ki?",
  products_services: "Otunda bintu ki oba empeereza ki? Mpaayo abamu.",
  payment_methods: "Oyagala okukkiriza payment otya? Mobile money, cards, sente, bank, oba byonna?",
  sell_channel: "Oteekateeka kutunda nnyo wa? Website, social media, WhatsApp, oba byonna?",
  logo: "Olina logo dda?",
...
const RW: CopyMap = {
  ...
  country: "Ubucuruzi bwawe buri muri igihugu ki?",
  products_services: "Utanga ibicuruzwa cyangwa serivisi ki? Vuga bike.",
  payment_methods: "Wifuza kwakira amafaranga ute? Mobile money, amakarita, cash, banki, cyangwa byose?",
  sell_channel: "Uteganya kugurisha cyane he? Urubuga, imbuga nkoranyambaga, WhatsApp, cyangwa byose?",
