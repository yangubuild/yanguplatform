...
import { Link2, Copy, ArrowLeft } from "lucide-react";
    ...
    <Popover>
      ...
      >
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white hover:bg-white/[0.06] transition-colors"
        >
          <Link2 className="w-4 h-4" style={{ color: "rgba(255,255,255,0.5)" }} />
          Copy link
        </button>
        <button
        ...
        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-white hover:bg-white/[0.06] transition-colors">
