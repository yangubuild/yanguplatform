        ...
        <div className="mt-3 pt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <div key={c.id} className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-baseline gap-1.5">
                      ...
                      {c.author_username && <span className="text-[9px] text-muted-foreground">@{c.author_username}</span>}
                    </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-0.5 mt-1.5">
              ...
              <button onClick={() => commentImageRef.current?.click()} className="p-1.5 rounded hover:bg-white/5 min-w-[32px] min-h-[32px] flex items-center justify-center text-muted-foreground" title="Image"><ImagePlus className="w-3.5 h-3.5" /></button>
              ...
              <button onClick={() => commentVideoRef.current?.click()} className="p-1.5 rounded hover:bg-white/5 min-w-[32px] min-h-[32px] flex items-center justify-center text-muted-foreground" title="Video"><Video className="w-3.5 h-3.5" /></button>
              <button className="p-1.5 rounded hover:bg-white/5 min-w-[32px] min-h-[32px] flex items-center justify-center text-muted-foreground" title="Emoji"><Smile className="w-3.5 h-3.5" /></button>
              <button className="p-1.5 rounded hover:bg-white/5 min-w-[32px] min-h-[32px] flex items-center justify-center text-muted-foreground" title="AI"><Sparkles className="w-3.5 h-3.5" /></button>
        ...
        {users.map((u) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0 text-left">
              ...
              {u.username && <p className="text-[9px] text-muted-foreground">@{u.username}</p>}
            </div>
