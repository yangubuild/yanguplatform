        ...
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            {checking ? (
              ...
              <>Your Google Drive is connected. Files will be saved to <span className="text-muted-foreground font-mono text-xs">/yangu/AdaAI/</span>.</>
            ) : (
              <>Connect your Google Drive to save files directly from ADA AI. Files will be saved to <span className="text-muted-foreground font-mono text-xs">/yangu/AdaAI/</span>.</>
            )}
          </DialogDescription>
        </DialogHeader>
