  ...
  return (
    <>
      <header
        ...
        style={{
          background: "rgba(12,17,14,0.72)", backdropFilter: "blur(14px)", borderBottom: "1px solid rgba(255,255,255,0.06)",
        }}
      >
        {/* Left */}
        ...
        <div className="flex items-center gap-1 sm:gap-2.5 overflow-hidden min-w-0 flex-1 justify-end">
          ...
          {/* Earnings button — icon-only below 360px, label on wider screens */}
          <Popover>
            <PopoverTrigger asChild>
              <button
