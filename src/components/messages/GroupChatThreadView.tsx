            ...
            return (
              <div key={msg.id} className={`group flex gap-2 ${isMine ? "justify-end" : "justify-start"}`}>
                ...
                <div className="relative max-w-[75%]">
                  ...
                  <div className="px-3 py-2 rounded-xl text-sm" style={{ background: isMine ? "rgba(16, 36, 24, 0.72)" : "rgba(8, 18, 13, 0.50)", backdropFilter: isMine ? "blur(18px)" : "blur(14px)", WebkitBackdropFilter: isMine ? "blur(18px)" : "blur(14px)", border: isMine ? "1px solid rgba(255,255,255,0.08)" : "1px solid rgba(255,255,255,0.05)", color: "#fff" }}>
