  ...
  return (
    <Comp
      ...
      className={cn(
        baseStyles,
        sizeClasses[size],
        "yangu-border-gradient bg-[#0A0F0C] text-foreground shadow-[0_6px_24px_-10px_hsl(25_100%_50%/0.35)] hover:bg-[#0E1512] hover:shadow-[0_8px_30px_-8px_hsl(25_100%_50%/0.45)] active:bg-[#080C0A] active:scale-[0.98]",
        className
      )}
      {...props}
    />
