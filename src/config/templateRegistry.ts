...
const EMENU_TEMPLATES: TemplatePreset[] = [
  ...
  // ═══ KEPT INTERNAL TEMPLATE (ACTIVE) ═══

  // ─── Simple Template A: Sweet Sips (DISABLED) ───
  {
  ...
  // ─── Yumix-Derived Templates (7 variations from https://yumix.framer.website) ───

  // 1. Yumix Bold — Full-featured dark food brand (closest to source)
  {
    ...
    reference: {
      ...
      label: "Yumix Framer food template — full extraction",
      sectionOrder: ["header_nav_cta", "hero_dark_split_discount", "category_cards_4col", "promo_banners_duo", "featured_menu_grid", "about_stats_row", "why_choose_us", "catering_events", "testimonials_carousel", "newsletter_cta", "footer_dark_multi"],
      layoutPatterns: ["dark_bg_hero", "discount_badge_overlay", "4col_category_cards", "dual_promo_banners", "6item_food_grid", "stats_counter_row", "icon_trust_badges", "event_category_cards", "avatar_testimonial_carousel", "newsletter_with_image"],
    },
    patches: {
      header: { schema: {
        layout_variant: "nav_right",
        ...
        show_search: false,
        menu_layout_style: "horizontal",
        nav_items: ["Home", "Menu", "About", "Blog"],
        background_style: "dark",
        background_color: "hsl(40 20% 8%)",
        cta_button: { text: "Contact Us", style: "outline_light" },
      } },
      hero: { schema: {
        layout_variant: "split",
        alignment: "left",
        background_style: "solid_dark",
        background_color: "hsl(40 20% 8%)",
        headline: "Satisfy Your Cravings, Delight Your Tastebuds",
        subheadline: "Best Food Forever",
        description: "We expertly whip up every single meal using only the freshest ingredients and the most delicious flavors, crafted just for you!",
        cta_text: "Explore Menu",
        cta_style: "yellow_rounded",
        media: { type: "image", source: "url", url: "", fit: "cover" },
        overlay_opacity: 0,
        spacing: "spacious",
        typography_style: "editorial_large",
        text_color: "light",
        social_proof: { type: "google_rating", rating: 4.5, platform: "Google" },
        discount_badge: { enabled: true, text: "50%", subtitle: "Limited Offer" },
      } },
      main_content: { schema: {
        display_mode: "grid",
        heading: "Find Your Best Delicious Flavor",
        description: "Scroll, select, and savor — our diverse menu brings together the best of local favorites and global flavors.",
        show_images: true,
        show_badges: true,
        show_dietary: true,
        layout_style: "grid",
        ...
        filters_enabled: false,
        sort_enabled: false,
        cards: { style: "image_top", image_ratio: "portrait", show_price: true, show_title: true, show_cta: true, card_style: "dark_overlay", hover_effect: "lift" },
        grid: { columns_desktop: 3, columns_mobile: 1, gap: "lg" },
        spacing: "spacious",
        category_showcase: {
          enabled: true,
          heading: "Discover Our Food Category",
          description: "From sizzling starters to satisfying mains and sweet endings.",
          columns: 4,
          items: [
            { title: "Main Dishes", count: "16 Items", media: [] },
            { title: "Beverages", count: "16 Items", media: [] },
            { title: "Delicious Desserts", count: "16 Items", media: [] },
            { title: "Hearty Vegetables", count: "16 Items", media: [] },
          ],
        },
        items: [
          { title: "Garlic Butter Shrimp", price: "$18.00", description: "Sautéed to enhance their natural sweetness", badges: ["popular"], media: [] },
          { title: "Classic Crust Deluxe", price: "$20.00", description: "A refreshing blend of flavors", media: [] },
          { title: "BBQ Grilled Ribs", price: "$16.00", description: "Slow-cooked and glazed with tangy sauce", badges: ["chef_special"], media: [] },
          { title: "Smoky Stack Burger", price: "$18.00", description: "Juicy ribeye paired with crispy golden fries", media: [] },
          { title: "Lemon Mint Iced Tea", price: "$18.00", description: "A refreshing mix of lemon and mint", badges: ["new"], media: [] },
          { title: "Spicy Grilled Chicken", price: "$18.99", description: "Soaked in tasty spices", badges: ["popular"], media: [] },
        ],
      } },
      offer: { schema: {
        layout_variant: "trust_badges",
        display_mode: "trust_badges",
        spacing: "spacious",
        heading: "More Than Just Food – It's a Flavor Story",
        description: "Bold flavors and fresh ingredients. From juicy burgers to refreshing drinks, every bite satisfies your cravings.",
        promo_banners: [
          { heading: "🔥 Delicious Deals Await!", description: "Enjoy Buy 1 Get 1 FREE on selected items every Friday!", cta_text: "Explore Menu" },
          { heading: "🔥 20% OFF Your First Order!", description: "Use code YUM20 at checkout. Taste the deal today!", cta_text: "Explore Menu" },
        ],
        stats: [
          { value: "213+", label: "Unique Menu Items" },
          { value: "1,958+", label: "Positive Reviews" },
          { value: "158+", label: "Outlets & Growing" },
          { value: "9,958+", label: "Orders Delivered" },
        ],
        items: [
          { title: "Expertly Crafted Recipes", description: "Our chefs mix creativity with flavor to make every dish unforgettable.", icon: "chef-hat" },
          { title: "Hygiene & Safety First", description: "Clean kitchens, sealed packaging, and contactless delivery.", icon: "shield" },
          { title: "Friendly Support Team", description: "Got a question or issue? Our team is just a message away.", icon: "headphones" },
          { title: "Exciting Offers & Deals", description: "Crave more, spend less. Enjoy exclusive discounts every week!", icon: "tag" },
        ],
        catering: {
          enabled: true,
          heading: "Catering Cravings for Every Celebration",
          description: "From intimate gatherings to grand celebrations.",
          items: [
            { title: "Social Event", count: "80+ Packages" },
            { title: "Corporate", count: "80+ Packages" },
            { title: "Wedding", count: "80+ Packages" },
          ],
        },
        testimonials: {
          enabled: true,
          heading: "Here's What Our Foodies Are Raving About!",
          subheading: "12K+ Happy Customers",
          items: [
            { name: "Erik Lindström", role: "Software Engineer", quote: "I honestly didn't think online food could be this awesome, but Yumix totally blew me away!" },
            { name: "Julian Müller", role: "Marketing Analyst", quote: "I've ordered from Yumix many times, and they've never messed up my order." },
            { name: "Nicolas Dubois", role: "Logistics Manager", quote: "Ordered for a family night. The kids loved the nuggets and mini sliders." },
            { name: "Sebastian Fischer", role: "Marketing Executive", quote: "It looked and tasted so fancy, like I was eating at a restaurant right at home!" },
          ],
        },
        newsletter: {
          enabled: true,
      ...
      footer: { schema: {
        ...
        background_color: "hsl(40 20% 8%)",
        columns: [
          { title: "Useful Links", links: ["Contact Us", "Terms & Conditions", "Privacy Policy"] },
          { title: "Quick Links", links: ["Home", "Food Menu", "About Us", "Blog & Article"] },
        ],
        contact: { phone: "(307) 555-0133", email: "hello@yourbusiness.com", address: "4886 Stroman Drive, South Stanton" },
  ...
  // 2. Yumix Lite — Simplified version, fewer sections
  {
    ...
    reference: {
      source: "link",
      url: "https://yumix.framer.website/",
      label: "Yumix Framer — lite variant (hero + categories + menu + about)",
      sectionOrder: ["header_nav_cta", "hero_dark_split", "category_cards_4col", "featured_menu_grid", "about_story", "footer_dark"],
      layoutPatterns: ["dark_bg_hero", "4col_category_cards", "3col_food_grid", "story_block_about"],
    },
    patches: {
      header: { schema: {
        layout_variant: "nav_right",
      ...
      hero: { schema: {
        ...
        subheadline: "Fresh & Flavorful",
        description: "Every meal crafted with the freshest ingredients and bold flavors.",
        cta_text: "Explore Menu",
        cta_style: "yellow_rounded",
        text_color: "light",
        media: { type: "image", source: "url", url: "", fit: "cover" },
      ...
      main_content: { schema: {
        ...
        columns_desktop: 3,
        columns_mobile: 1,
        cards: { style: "image_top", image_ratio: "portrait", show_price: true, show_title: true, show_cta: false, card_style: "dark_overlay", hover_effect: "lift" },
        grid: { columns_desktop: 3, columns_mobile: 1, gap: "lg" },
        spacing: "spacious",
        items: [
          { title: "Garlic Butter Shrimp", price: "$18.00", description: "Sautéed to perfection", badges: ["popular"], media: [] },
          { title: "BBQ Grilled Ribs", price: "$16.00", description: "Slow-cooked with tangy glaze", media: [] },
          { title: "Smoky Stack Burger", price: "$18.00", description: "Juicy patty with golden fries", media: [] },
        ],
      } },
      offer: { schema: {
        layout_variant: "story_block",
        ...
        description: "At our kitchen, we believe great food unites people. Bold meals that blend global flavors with local love.",
        cta_text: "Learn More",
        spacing: "spacious",
      } },
      footer: { schema: {
        ...
        background_color: "hsl(40 20% 8%)",
        columns: [
          { title: "Menu", links: ["Home", "Menu", "About"] },
          { title: "Contact", links: ["Phone", "Email"] },
        ],
        copyright: "All rights reserved.",
      } },
    },
  ...
  // 3. Yumix Promo — Deals & promotions focused
  {
    ...
    reference: {
      source: "link",
      url: "https://yumix.framer.website/",
      label: "Yumix Framer — promo/deals emphasis",
      sectionOrder: ["header_nav_cta", "hero_dark_discount", "promo_banners_duo", "featured_menu_grid", "catering_events", "newsletter_cta", "footer_dark"],
      layoutPatterns: ["dark_bg_hero", "discount_badge_overlay", "dual_promo_banners", "3col_food_grid", "event_category_cards", "newsletter_with_image"],
    },
    patches: {
      header: { schema: {
        layout_variant: "nav_right",
        ...
        show_name: true,
        name_next_to_logo: true,
        nav_items: ["Home", "Menu", "Deals"],
        background_style: "dark",
        background_color: "hsl(40 20% 8%)",
        cta_button: { text: "Order Now", style: "yellow_rounded" },
      } },
      hero: { schema: {
        layout_variant: "split",
        alignment: "left",
        background_style: "solid_dark",
        background_color: "hsl(40 20% 8%)",
        headline: "Delicious Deals Await!",
        subheadline: "Save Big on Every Bite",
        description: "Enjoy exclusive discounts and limited-time offers on your favorite dishes.",
      ...
      main_content: { schema: {
        ...
        description: "Our most ordered dishes at unbeatable prices",
        show_images: true,
        show_badges: true,
        layout_style: "grid",
        columns_desktop: 3,
        ...
        grid: { columns_desktop: 3, columns_mobile: 1, gap: "lg" },
        items: [
          { title: "Garlic Butter Shrimp", price: "$18.00", sale_price: "$14.40", badges: ["popular"], description: "Sautéed to perfection", media: [] },
          { title: "BBQ Grilled Ribs", price: "$16.00", sale_price: "$12.80", description: "Tangy sauce glaze", media: [] },
          { title: "Spicy Grilled Chicken", price: "$18.99", sale_price: "$15.19", badges: ["chef_special"], description: "Soaked in bold spices", media: [] },
        ],
      } },
      offer: { schema: {
        layout_variant: "trust_badges",
        display_mode: "trust_badges",
        promo_banners: [
          { heading: "🔥 Buy 1 Get 1 FREE", description: "On selected items every Friday!", cta_text: "Explore Menu" },
          { heading: "🔥 20% OFF First Order", description: "Use code YUM20 at checkout!", cta_text: "Order Now" },
        ],
        catering: {
          enabled: true,
          heading: "Catering for Events",
          items: [
            { title: "Social Event", count: "80+ Packages" },
            { title: "Corporate", count: "80+ Packages" },
            { title: "Wedding", count: "80+ Packages" },
        ...
        newsletter: { enabled: true, heading: "Get Exclusive Deals", cta_text: "Subscribe" },
      } },
      footer: { schema: {
        layout_variant: "multi_column",
        display_mode: "multi_column",
        ...
        background_color: "hsl(40 20% 8%)",
        columns: [
          { title: "Quick Links", links: ["Home", "Menu", "Deals", "Contact"] },
        ],
        copyright: "All rights reserved.",
      } },
    },
  ...
  // 4. Yumix Social — Testimonials & social proof focused
  {
    ...
    reference: {
      source: "link",
      url: "https://yumix.framer.website/",
      label: "Yumix Framer — social proof emphasis",
      sectionOrder: ["header_nav_cta", "hero_dark_rating", "featured_menu_grid", "stats_counter_row", "testimonials_carousel", "about_story", "footer_dark"],
      layoutPatterns: ["dark_bg_hero", "google_rating_badge", "3col_food_grid", "stats_counter_row", "avatar_testimonial_carousel", "story_block_about"],
    },
    patches: {
      header: { schema: {
        layout_variant: "nav_right",
        ...
        show_name: true,
        name_next_to_logo: true,
        nav_items: ["Home", "Menu", "Reviews", "About"],
        background_style: "dark",
        background_color: "hsl(40 20% 8%)",
      } },
      hero: { schema: {
        ...
        background_style: "solid_dark",
        background_color: "hsl(40 20% 8%)",
        headline: "Loved by Thousands of Foodies",
        subheadline: "Taste the Difference",
        description: "Join 12,000+ happy customers who trust us for bold flavors and fresh ingredients.",
        cta_text: "Explore Menu",
        cta_style: "yellow_rounded",
        text_color: "light",
        media: { type: "image", source: "url", url: "", fit: "cover" },
      ...
      main_content: { schema: {
        ...
        description: "The flavors our customers can't stop ordering",
        show_images: true,
        show_badges: true,
        layout_style: "grid",
        columns_desktop: 3,
        columns_mobile: 1,
        cards: { style: "image_top", image_ratio: "portrait", show_price: true, show_title: true, card_style: "dark_overlay", hover_effect: "lift" },
        grid: { columns_desktop: 3, columns_mobile: 1, gap: "lg" },
        items: [
          { title: "Garlic Butter Shrimp", price: "$18.00", badges: ["popular"], description: "Sautéed to perfection", media: [] },
          { title: "Smoky Stack Burger", price: "$18.00", badges: ["best_seller"], description: "Juicy patty with all the fixings", media: [] },
          { title: "Spicy Grilled Chicken", price: "$18.99", badges: ["popular"], description: "Bold spices, tender meat", media: [] },
        ],
      } },
      offer: { schema: {
        layout_variant: "trust_badges",
        display_mode: "trust_badges",
        stats: [
          { value: "213+", label: "Menu Items" },
          { value: "1,958+", label: "Positive Reviews" },
          { value: "158+", label: "Outlets" },
          { value: "9,958+", label: "Orders Delivered" },
        ],
        testimonials: {
          enabled: true,
          heading: "What Our Foodies Say",
          subheading: "12K+ Happy Customers",
          items: [
            { name: "Erik Lindström", role: "Software Engineer", quote: "Yumix totally blew me away! It looked and tasted so fancy." },
            { name: "Julian Müller", role: "Marketing Analyst", quote: "They've never messed up my order. Everything is hot, fresh, and tasty." },
            { name: "Nicolas Dubois", role: "Logistics Manager", quote: "The kids loved the nuggets. Affordable, tasty, and perfect for everyone." },
            { name: "Sebastian Fischer", role: "Marketing Executive", quote: "Like eating at a restaurant right at home!" },
          ],
        },
        story_block: {
          enabled: true,
          heading: "Satisfy Your Cravings",
          description: "We believe great food unites people. Bold meals that blend global flavors with local love.",
          cta_text: "Learn More",
        },
      } },
      footer: { schema: {
        ...
        background_color: "hsl(40 20% 8%)",
        columns: [
          { title: "Quick Links", links: ["Home", "Menu", "Reviews", "About"] },
  ...
  // 5. Yumix Warm — Light/warm variant of the same structure
  {
    ...
    reference: {
      source: "link",
      url: "https://yumix.framer.website/",
      label: "Yumix Framer — warm light palette variant",
      sectionOrder: ["header_nav_cta", "hero_warm_split", "category_cards_4col", "featured_menu_grid", "about_stats", "testimonials", "footer_warm"],
      layoutPatterns: ["warm_cream_hero", "4col_category_cards", "3col_food_grid", "stats_counter_row", "avatar_testimonial_carousel"],
    },
    patches: {
      header: { schema: {
        layout_variant: "nav_right",
      ...
      hero: { schema: {
        ...
        headline: "Satisfy Your Cravings, Delight Your Tastebuds",
        subheadline: "Best Food Forever",
        description: "Fresh ingredients, bold flavors, crafted just for you!",
        cta_text: "Explore Menu",
        cta_style: "dark_rounded",
        text_color: "dark",
        media: { type: "image", source: "url", url: "", fit: "cover" },
        spacing: "spacious",
        typography_style: "editorial_large",
        social_proof: { type: "google_rating", rating: 4.5 },
      } },
      main_content: { schema: {
        display_mode: "grid",
        heading: "Discover Our Food Category",
        ...
        columns_desktop: 3,
        columns_mobile: 1,
        cards: { style: "image_top", image_ratio: "portrait", show_price: true, show_title: true, card_style: "rounded", hover_effect: "lift" },
        grid: { columns_desktop: 3, columns_mobile: 1, gap: "lg" },
        items: [
          { title: "Garlic Butter Shrimp", price: "$18.00", badges: ["popular"], description: "Sautéed to perfection", media: [] },
          { title: "Classic Crust Deluxe", price: "$20.00", description: "A classic blend of flavors", media: [] },
          { title: "BBQ Grilled Ribs", price: "$16.00", badges: ["chef_special"], description: "Slow-cooked with tangy sauce", media: [] },
          { title: "Smoky Stack Burger", price: "$18.00", description: "Juicy patty, golden fries", media: [] },
          { title: "Lemon Mint Iced Tea", price: "$18.00", badges: ["new"], description: "Refreshing lemon and mint", media: [] },
          { title: "Spicy Grilled Chicken", price: "$18.99", description: "Bold spices, tender meat", media: [] },
        ],
      } },
      offer: { schema: {
        layout_variant: "trust_badges",
        ...
        items: [
          { title: "Expertly Crafted Recipes", description: "Creativity meets flavor in every dish.", icon: "chef-hat" },
          { title: "Hygiene & Safety First", description: "Clean kitchens, sealed packaging.", icon: "shield" },
          { title: "Friendly Support", description: "Our team is just a message away.", icon: "headphones" },
        ],
        testimonials: {
          enabled: true,
          heading: "Customer Reviews",
          items: [
            { name: "Erik Lindström", quote: "Yumix totally blew me away!" },
            { name: "Julian Müller", quote: "They've never messed up my order." },
          ],
        },
      } },
      footer: { schema: {
        ...
        display_mode: "multi_column",
        columns: [
          { title: "Links", links: ["Home", "Menu", "About", "Contact"] },
          { title: "Contact", links: ["Phone", "Email"] },
        ],
        copyright: "All rights reserved.",
      } },
  ...
  // 6. Yumix Catering — Event/catering focus
  {
    ...
    reference: {
      source: "link",
      url: "https://yumix.framer.website/",
      label: "Yumix Framer — catering/events emphasis",
      sectionOrder: ["header_nav_cta", "hero_dark_split", "menu_highlights", "catering_events_3col", "stats_row", "testimonials", "newsletter", "footer_dark"],
      layoutPatterns: ["dark_bg_hero", "3col_food_grid", "event_category_cards", "stats_counter_row", "avatar_testimonial_carousel"],
    },
    patches: {
      header: { schema: {
        layout_variant: "nav_right",
        ...
        show_name: true,
        name_next_to_logo: true,
        nav_items: ["Home", "Menu", "Catering", "Contact"],
        background_style: "dark",
        background_color: "hsl(40 20% 8%)",
        cta_button: { text: "Get a Quote", style: "yellow_rounded" },
      } },
      hero: { schema: {
        layout_variant: "split",
        alignment: "left",
        background_style: "solid_dark",
        background_color: "hsl(40 20% 8%)",
        headline: "Catering for Every Celebration",
        subheadline: "Events & Parties",
        description: "From intimate gatherings to grand celebrations — we deliver delicious food that impresses every guest.",
      ...
      main_content: { schema: {
        display_mode: "grid",
        heading: "Popular Menu Picks",
        description: "A preview of what we can bring to your event",
        show_images: true,
        show_badges: true,
        layout_style: "grid",
        columns_desktop: 3,
        ...
        grid: { columns_desktop: 3, columns_mobile: 1, gap: "lg" },
        items: [
          { title: "Garlic Butter Shrimp", price: "$18.00", badges: ["popular"], description: "Perfect for appetizer platters", media: [] },
          { title: "BBQ Grilled Ribs", price: "$16.00", description: "A crowd favorite at every event", media: [] },
          { title: "Smoky Stack Burger", price: "$18.00", description: "Slider versions available for parties", media: [] },
        ],
      } },
      offer: { schema: {
        layout_variant: "trust_badges",
        ...
        catering: {
          ...
          description: "Choose the perfect package for your occasion.",
          items: [
            { title: "Social Event", count: "80+ Packages", description: "Birthday, anniversary, house party" },
            { title: "Corporate", count: "80+ Packages", description: "Team lunch, conference, product launch" },
            { title: "Wedding", count: "80+ Packages", description: "Reception, cocktail, full service" },
          ],
        },
        stats: [
          { value: "158+", label: "Events Catered" },
          { value: "9,958+", label: "Meals Served" },
          { value: "1,958+", label: "Happy Clients" },
        ],
        testimonials: {
          enabled: true,
          heading: "What Event Hosts Say",
          items: [
            { name: "Nicolas Dubois", role: "Event Planner", quote: "The kids loved the nuggets and the adults loved the ribs. Perfect for our family event!" },
            { name: "Sebastian Fischer", role: "Corporate Organizer", quote: "Professional, on time, and the food was exceptional." },
          ],
        },
        newsletter: { enabled: true, heading: "Get Catering Updates", cta_text: "Subscribe" },
      } },
      footer: { schema: {
        layout_variant: "multi_column",
        display_mode: "multi_column",
        ...
        background_color: "hsl(40 20% 8%)",
        columns: [
          { title: "Services", links: ["Social Events", "Corporate", "Weddings", "Custom Menus"] },
          { title: "Contact", links: ["Phone", "Email", "Location"] },
        ],
        copyright: "All rights reserved.",
      } },
  ...
  // 7. Yumix Minimal — Stripped-down minimal dark menu
  {
    ...
    reference: {
      source: "link",
      url: "https://yumix.framer.website/",
      label: "Yumix Framer — minimal stripped variant",
      sectionOrder: ["header_minimal", "hero_dark_clean", "featured_menu_3items", "about_block", "footer_compact"],
      layoutPatterns: ["dark_bg_hero", "3col_food_grid", "story_block_about", "compact_footer"],
    },
    patches: {
      header: { schema: {
        layout_variant: "nav_right",
      ...
      hero: { schema: {
        ...
        background_style: "solid_dark",
        background_color: "hsl(40 20% 8%)",
        headline: "Delight Your Tastebuds",
        description: "Fresh ingredients. Bold flavors. Crafted for you.",
        cta_text: "View Menu",
        cta_style: "yellow_rounded",
        text_color: "light",
        media: { type: "image", source: "url", url: "", fit: "cover" },
      ...
      main_content: { schema: {
        ...
        columns_desktop: 3,
        columns_mobile: 1,
        cards: { style: "image_top", image_ratio: "square", show_price: true, show_title: true, card_style: "clean", hover_effect: "lift" },
        grid: { columns_desktop: 3, columns_mobile: 1, gap: "md" },
        items: [
          { title: "Garlic Butter Shrimp", price: "$18.00", badges: ["popular"], description: "Sautéed to perfection", media: [] },
          { title: "BBQ Grilled Ribs", price: "$16.00", description: "Tangy sauce glaze", media: [] },
          { title: "Smoky Stack Burger", price: "$18.00", description: "Juicy with golden fries", media: [] },
        ],
      } },
      offer: { schema: {
        layout_variant: "story_block",
        display_mode: "story_block",
        heading: "Our Story",
        description: "We believe great food unites people. From juicy burgers to chilled shakes, every dish is crafted with care.",
        cta_text: "Learn More",
        spacing: "comfortable",
      } },
      footer: { schema: {
        ...
        background_color: "hsl(40 20% 8%)",
        columns: [
          { title: "Links", links: ["Menu", "About", "Contact"] },
        ],
