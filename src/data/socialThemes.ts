...
export const SYSTEM_THEMES: SocialTheme[] = [
  { key: "new-year", name: "New Year", templateCount: 12, mood: "celebratory, festive, fresh start, countdown, sparkling", colorHint: "gold, silver, black", isSystem: true },
  ...
  { key: "bold-tech", name: "Bold Tech", templateCount: 11, mood: "futuristic, bold, tech-forward, geometric, neon", colorHint: "electric blue, neon", isSystem: true },
  { key: "bold-words", name: "Bold Words", templateCount: 15, mood: "typography-heavy, statement, impactful text, editorial", colorHint: "high contrast, monochrome", isSystem: true },
  ...
  { key: "fresh-pop", name: "Fresh Pop", templateCount: 16, mood: "colorful, energetic, pop art, bold, vibrant, youthful", colorHint: "bright primary colors", isSystem: true },
  ...
  { key: "influencer-captions", name: "Influencer Captions", templateCount: 8, mood: "caption overlays on photos, personal, authentic", colorHint: "transparent overlays", isSystem: true },
  ...
  { key: "simply-image", name: "Simply Image", templateCount: 1, mood: "photo-only, full bleed image, minimal text overlay", colorHint: "photo-driven", isSystem: true },
  ...
  { key: "st-patricks", name: "St. Patrick's Day", templateCount: 10, mood: "irish, lucky, green, shamrock, festive", colorHint: "green, gold", isSystem: true },
