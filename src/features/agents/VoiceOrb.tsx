  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[104px] left-3 sm:left-auto z-40 flex h-14 w-14 sm:bottom-6 sm:right-6 items-center justify-center rounded-full transition active:scale-95"
      >
