...
export const emenuEngine: BuilderEngine = {
  ...
  defaultSections: [
    ...
    { type: "featured", schema: { heading: "Featured Dishes", description: "Chef's top picks", items: [] } },
    { type: "offer", schema: { heading: "Special Offers", description: "", items: [] }, core_slot: "offer" },
